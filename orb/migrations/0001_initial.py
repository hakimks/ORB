    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.ForeignKey(related_name='resource_create_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('update_user', models.ForeignKey(related_name='resource_update_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.ForeignKey(related_name='resource_file_create_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('resource', models.ForeignKey(to='orb.Resource', on_delete=models.CASCADE)),
                ('update_user', models.ForeignKey(related_name='resource_file_update_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('create_user', models.ForeignKey(related_name='resource_relationship_create_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('resource', models.ForeignKey(related_name='resource', to='orb.Resource', on_delete=models.CASCADE)),
                ('resource_related', models.ForeignKey(related_name='resource_related', to='orb.Resource', on_delete=models.CASCADE)),
                ('update_user', models.ForeignKey(related_name='resource_relationship_update_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('create_user', models.ForeignKey(related_name='resourcetag_create_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('resource', models.ForeignKey(to='orb.Resource', on_delete=models.CASCADE)),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource', models.ForeignKey(default=None, blank=True, to='orb.Resource', null=True, on_delete=models.CASCADE)),
                ('resource_file', models.ForeignKey(default=None, blank=True, to='orb.ResourceFile', null=True, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('create_user', models.ForeignKey(related_name='resource_url_create_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('resource', models.ForeignKey(to='orb.Resource', on_delete=models.CASCADE)),
                ('update_user', models.ForeignKey(related_name='resource_url_update_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(default=None, blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(to='orb.Category', on_delete=models.CASCADE)),
                ('create_user', models.ForeignKey(related_name='tag_create_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('parent_tag', models.ForeignKey(default=None, blank=True, to='orb.Tag', null=True, on_delete=models.CASCADE)),
                ('update_user', models.ForeignKey(related_name='tag_update_user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('organisation', models.ForeignKey(related_name='organisation', to='orb.Tag', on_delete=models.CASCADE)),
                ('role', models.ForeignKey(related_name='role', default=None, blank=True, to='orb.Tag', null=True, on_delete=models.CASCADE)),
        ...
        migrations.AddField(
            ...
            name='resource_url',
            field=models.ForeignKey(default=None, blank=True, to='orb.ResourceURL', null=True, on_delete=models.CASCADE),
        ...
        migrations.AddField(
            ...
            name='tag',
            field=models.ForeignKey(to='orb.Tag', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='resourcetag',
